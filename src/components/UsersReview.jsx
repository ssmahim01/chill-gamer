...
const UsersReview = () => {
    return (
        <div className="card border border-gray-200 flex md:flex-row flex-col-reverse justify-between items-center md:gap-0 gap-6 shadow-lg">
            ...
            <h2 className="lg:text-5xl text-2xl font-extrabold">Reviews for Inspiration</h2>
            <p className="lg:text-base text-sm font-medium">Suppose, Review is the one source of inspiration. Users can share about of games in this web. A review includes Title, Description, photo URL and anything else.</p>
